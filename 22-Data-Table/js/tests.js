...
describe("TP 1 - Ventas de PC", () => {
    ...
    it("**vendedoraDelMes(mes, anio)** devuelve el nombre de la vendedora que más vendió en plata en el mes. O sea no cantidad de ventas, sino importe total de las ventas. El importe de una venta es el que indica la función `precioMaquina`. El mes es un número entero que va desde el 1 (enero) hasta el 12 (diciembre). -Ej03", () => {
        const mes = 1;
        const anio = 2019;
    ...
    it("ventasVendedora(nombre): Obtener las ventas totales realizadas por una vendedora sin límite de fecha. Ej05", () => {
